...
import { Sun, Home, Zap, ArrowRight, ShieldCheck, TrendingDown, Sparkles } from 'lucide-react';
import { IMAGES } from '../constants/images';

export const CommunityNetworkHeroVisual: React.FC = () => {
  const [activeSegment, setActiveSegment] = useState<'flow' | 'prosumer' | 'consumer'>('flow');

  return (
    <div className="w-full rounded-3xl overflow-hidden border border-[#E6E2D8] dark:border-[#2C2D29] bg-[#FFFFFF] dark:bg-[#171816] shadow-xl dark:shadow-2xl transition-all">
      {/* Top Main Showcase: Editorial Split Layout with Real Photography */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
        {/* Left Side: Real Photography Container with Soft Gradient Overlay */}
        <div className="lg:col-span-7 relative min-h-[360px] sm:min-h-[440px] overflow-hidden group">
          <img
          ...
          <div className="absolute bottom-6 left-6 right-6">
            <div className="p-4 sm:p-5 rounded-2xl bg-[#FAF8F5]/95 dark:bg-[#171816]/95 backdrop-blur-md border border-[#E6E2D8]/80 dark:border-[#2C2D29] shadow-lg">
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <div className="text-sm sm:text-base font-bold text-[#1A1B19] dark:text-[#EDEDE8]">
                    Rajesh's Solar Roof → Ananya's Home
                  </div>
                </div>
                <div className="text-right">
                  ...
                  <div className="text-[10px] text-[#8D9188] font-mono">Delivered cleanly</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-5 p-6 sm:p-8 flex flex-col justify-between bg-[#FAF8F5] dark:bg-[#141513]">
          <div>
            ...
            <p className="mt-3 text-xs sm:text-sm text-[#686B63] dark:text-[#9EA299] leading-relaxed">
              When you trade solar electricity with your neighbors, power travels only hundreds of meters instead of hundreds of kilometers through high-voltage utility grids.
            </p>
          </div>

          {/* Human-Centered Metric List */}
          <div className="mt-6 space-y-3">
            <div className="p-3.5 rounded-2xl bg-[#FFFFFF] dark:bg-[#1D1E1B] border border-[#E6E2D8] dark:border-[#2A2B27] flex items-center justify-between">
